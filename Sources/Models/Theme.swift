...
struct ThemeColors: Identifiable, Equatable {
...
/// 所有可选主题（不含 "auto"，auto 在 AppState.theme 中动态解析）
let THEMES: [ThemeColors] = [
    ThemeColors(id: "obsidian", name: L("theme.obsidian"),
    ...
    ThemeColors(id: "abyss", name: L("theme.abyss"),
    ...
    ThemeColors(id: "sandstone", name: L("theme.sandstone"),
    ...
    ThemeColors(id: "neon", name: L("theme.neon"),
    ...
    ThemeColors(id: "frost", name: L("theme.frost"),
    ...
    ThemeColors(id: "paper", name: L("theme.paper"),
